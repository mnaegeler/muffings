...
class CategoriasPostsController extends \BaseController
{  
    private static $class = 'CategoriasPosts';
    
    private static $classUrl = 'categorias-posts';
    
    protected $categoriasPosts;
     ...
     * @return void
    **/ 
    public function __construct(CategoriasPosts $categoriasPosts)
    {       
        parent::__construct();
         
        $this->categoriasPosts = $categoriasPosts;
        $this->storeNav = array();  
    ...
    **/
    ...
    {   
        ...
        $validator = $this->categoriasPosts->validate($input);
